def languages(item):
        lan = ['afrikaans' 'albanian', 'amharic', 'arabic', 'armenian', 'assamese', 'aymara', 'azerbaijani',
            ...
            'english', 'esperanto', 'estonian','ewe', 'filipino', 'finnish', 'french', 'frisian', 'galician', 'georgian',
            ...
            'malagasy', 'malay', 'malayalam','maltese', 'maori', 'marathi', 'meiteilon (manipuri)','mni-Mtei', 'mizo',
            'mongolian', 'myanmar', 'nepali', 'norwegian', 'odia (oriya)', 'oromo', 'pashto', 'persian','polish',
            'portuguese', 'punjabi', 'quechua', 'romanian', 'russian', 'samoan', 'sanskrit', 'scots gaelic', 'sepedi',
